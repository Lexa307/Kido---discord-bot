...
create table if not exists shop ( -- shop of ability setup private role
	`id` varchar(255),
...
DELIMITER $$
CREATE PROCEDURE add_user(in userid int)
BEGIN
    INSERT INTO users (id, uses, inventory) VALUES (convert(userid,CHAR ), '{"hug": 0, "kiss": 0, "bite": 0, "pat": 0, "smoke": 0, "beer": 0, "rip": 0, "shot": 0, "poke": 0, "slap": 0, "lick": 0, "coffee": 0, "sad": 0, "sex": 0 }','{"elite": 0, "private_3": 0,"private_5": 0, "private_7": 0}');
END $$
DELIMITER ; 